...
function Details(){
	...
	const { gif } = useParams();
	const GIPHY_API = `https://api.giphy.com/v1/gifs/${gif.id}?api_key=${process.env.REACT_APP_GIPHY_API_KEY}`
